	...
	if request.method == "POST" :
		...
		try:
			...
			if api[0]['Category']['Name'] == "Good" :
				...
				category_color = "hazardous"
			elif api[0]['Category']['Name'] == None :
				category_description = "Sorry no area found."
				category_color = "hazardous"
			print("Here")
			return render(request, 'index.html', {'api': api, 'category_description': category_description, 'category_color': category_color, 'zipcode': zipcode})


		except Exception as e:
			api = "Error.."
			return render(request, 'home.html', {'api': api, 'zipcode': zipcode})
		...
		return render(request, 'index.html', {'api': api, 'category_description': category_description, 'category_color': category_color, 'zipcode': 20002})
